...
// определяет направление передачи данных (чтение с устройства I2C) 
//в функциях i2c_start(), i2c_rep_start()*/
#define I2C_READ    1

// определяет направление передачи данных (запись на устройство I2C)
// в функциях i2c_start(), i2c_rep_start() */
#define I2C_WRITE   0
...
uint16_t ads1115_readADC_SingleEnded(uint8_t addr, uint8_t channel, 
ads1115_datarate dr, ads1115_fsr_gain gain);
